...
const LoginPage = () => {
  ...
  return (
    <div className=" flex justify-center items-center h-screen relative">
      ...
      <div className="w-full max-w-4xl grid grid-cols-1 mx-4 md:grid-cols-2 rounded-lg shadow-lg overflow-hidden z-50">
          ...
          <form className="space-y-6" >
            ...
            <div>
              ...
              <input
                type="text"
                id="name"
                className="w-full p-2.5 border rounded-lg text-gray-900 bg-gray-50 focus:ring-blue-500 focus:border-blue-500"
